        ...
        var resize = function () {
          ...
          if (Lightbox.rotateDeg === 90 || Lightbox.rotateDeg === 270) {
            ...
            element.css({
              ...
              'marginTop': formatDimension((imageDisplayDimensions.width > imageDisplayDimensions.height) ? 0 : -Math.abs(imageDisplayDimensions.width - imageDisplayDimensions.height) / 2),
            ...
            angular.element(
              ...
              'height': formatDimension(imageDisplayDimensions.width + 2)
            });
            ...
            angular.element(
              ...
              'height': formatDimension(imageDisplayDimensions.height + 2)
            });
